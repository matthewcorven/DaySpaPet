...
public class UserLogin : Endpoint<LoginRequest> {
  ...
  public override async Task HandleAsync(LoginRequest req, CancellationToken ct) {
    ...
    IConfigurationSection jwtPublicSigningKey = Config.GetRequiredSection("Authentication:Schemes:Bearer:PublicSigningKey");
    IConfigurationSection jwtPrivateSigningKey = Config.GetRequiredSection("Authentication:Schemes:Bearer:PrivateSigningKey");
    IConfigurationSection jwtIssuer = Config.GetRequiredSection("Authentication:Schemes:Bearer:ValidIssuer");
    IConfigurationSection jwtAudiences = Config.GetRequiredSection("Authentication:Schemes:Bearer:ValidAudiences");
